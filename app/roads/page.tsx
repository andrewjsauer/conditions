    ...
    <>
      ...
      <div className="mx-auto my-20 max-w-4xl px-10">
        ...
        <Link
          ...
          className="my-4 flex items-center justify-center rounded-3xl bg-[#476c77] px-4 py-4 text-lg font-bold text-white transition-colors duration-300 ease-in-out hover:bg-[#efb071] hover:text-black"
        >
